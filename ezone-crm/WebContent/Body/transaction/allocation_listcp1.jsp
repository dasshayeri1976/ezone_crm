...
<li >Engineer Allocation Carry Out Print</li>
</ul>
</div>
...
<s:if test="usList">    
<s:form action="printview" namespace="/" method="post" id="frm1" onsubmit="return createTarget(this.target)" target="formtarget">
		
		
		<div style="height:335px;">
		
		<table cellpadding="0" cellspacing="0" border="0" id="table" class="imagetable" style="width:75%" >
		<thead>
