...
<sj:dialog
    ...
    <table style="color:#000000; width:80%">
     ...
     <tr>
        ...
        <td width="12.5%" style="padding-left:15px; padding-right:15px;"><s:textfield name="formbean.hdd"  id="hdd" size="30" cssStyle="height:20px;border:1px solid #ccc;background:#FFFF99"></s:textfield></td>       
...
<s:actionmessage/>
  ...
  <legend style="color:red;"><h3>Jobwork Entry</h3></legend>
...
<s:actionmessage/>
   ...
   <sj:dialog id="mybuttondialog" autoOpen="false" modal="true"
				...
				<fieldset
					...
					<legend style="color: red;"><h3>Engineer Allocation</h3></legend>
	...
	<display:column property="ccode"   title="Jobwork_Id"   sortable="false" headerClass="sortable" />
    ...
    <display:column property="cust_ref_id" title="Customer Reference ID" sortable="false" headerClass="sortable" />
	...
	<display:column title="Quotation" media="html" style="text-align: center;width:8%;" >
    	<a href="<s:url action="quotationdetails" namespace="/" ><s:param  name="id" value="%{#attr.table.id}"></s:param><s:param name="name" value="%{#attr.table.name}"></s:param><s:param name="scode" value="%{#attr.table.scode}"></s:param><s:param name="address" value="%{#attr.table.address}"></s:param><s:param name="cust_ref_id" value="%{#attr.table.cust_ref_id}"></s:param></s:url>" style="text-decoration:none;font-size:12px;" class="print">Quotation</a>
    </display:column>   
