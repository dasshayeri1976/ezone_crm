...
<s:actionmessage/>
	...
	<display:column property="premarks"   title="CoordinatorRemarks"   sortable="false" headerClass="sortable" />
	<display:column property="edate"   title="Reply Date"   sortable="false" headerClass="sortable" /> 		
