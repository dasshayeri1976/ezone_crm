...
<s:form action="sparereturndetails" namespace="/" method="post">
...
<br/>
<s:if test="usList2">
<display:table id="table"  name="usList2" pagesize="10000"  class="imagetable" requestURI="/preportdetails"  defaultorder="ascending"  export="true" style="width:90%">
	
	<display:caption media="html" style="color:red; font-weight:bold; padding-bottom:10px;">
	 Spare Return Report<br/>
	...
	<display:column property="name"   title="EngName"    sortable="false" headerClass="sortable" />
	
	<display:column property="bname"   title="Spare"     sortable="false" headerClass="sortable"/>
		
	<display:column property="cdate"   title="Allocation_Date"     sortable="false" headerClass="sortable"/>
		
	<display:column property="address"   title="Spare_Return "     sortable="false" headerClass="sortable"/>
	
	<display:column property="pon"   title="Spare_Defect"    sortable="false" headerClass="sortable" />
	
	<display:column property="mcode"   title="Spare_Doa"    sortable="false" headerClass="sortable" />
	
	<display:column property="fname"   title="Return_Date"   sortable="false" headerClass="sortable" />
