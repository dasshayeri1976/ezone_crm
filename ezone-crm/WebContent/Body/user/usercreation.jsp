...
<s:actionmessage/>
  ...
  <table width="80%" style="padding:10px;" >
	 ...
	 <tr>
        ...
        <td width="12.5%" style="padding-left:15px; padding-right:15px;">Role</td>
	    ...
	    <td width="12.5%" style="padding-left:15px; padding-right:15px;"><s:select name="formbean.roll" id="roll" list="#{'':'', 'ROLE_ADMIN':'ROLE_ADMIN', 'ROLE_RECEPTION':'ROLE_RECEPTION', 'ROLE_SERVICE':'ROLE_SERVICE'}" cssStyle=" border:1px solid #ccc;height:25px;background:#FFFF99;width:110px;"></s:select></td>
      ...
      <tr>
		...
		<td width="12.5%" style="padding-left:15px; padding-right:15px;" valign="top"><s:select name="formbean.ctype" id="ctype" list="#{'':'', 'ON SITE':'ON SITE', 'CARRY IN':'CARRY IN', 'ALL':'ALL'}" cssStyle=" border:1px solid #ccc;height:25px;background:#FFFF99;width:120px;" onchange="jobid();"></s:select></td>
       ...
       <select id="cc" name="formbean.bname"  class="easyui-combogrid" style="width:125px;" data-options="
			panelWidth: 200,
			multiple: true,
			idField: 'productname',
			value:'<s:property value="formbean.bname"/>',
