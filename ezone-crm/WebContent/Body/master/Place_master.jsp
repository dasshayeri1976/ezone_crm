...
<script language="javascript" type="text/javascript">
	...
	function citycode() {
		...
		var url = "./Body/master/citycode.jsp";
		url += "?count=" + s1; // + "&sec=" + s;
		//url +="?count=" +str+"&date1="+s;
...
<s:actionmessage/>
  ...
  <legend style="color:red;"><h3>Place Creation</h3></legend>
  
  <s:form action="placecreation" namespace="/" method="post">
  <input type="hidden" name="placecode" id="placecode"/>
  <input type="hidden" name="formbean.id" value="<s:property value="formbean.id"/>"/>
  <input type="hidden" name="formbean.city" id="city" value="<s:property value="formbean.city"/>"/>
  ...
  <table width="50%" style="padding:10px;" >
	 ...
	 <tr>	   	       
        ...
        <td width="12.5%" style="padding-left:15px; padding-right:15px;"><s:textfield name="formbean.pcode" id="pcode"  size="10" cssStyle="height:20px;border:1px solid #ccc;background:#FFFF99" tabindex="2"></s:textfield></td>
        <td width="12.5%" style="padding-left:15px; padding-right:15px;">City_Name</td>
        <td width="12.5%" style="padding-left:15px; padding-right:15px;"><s:select name="formbean.sname" list="usList1" id="sname" listKey="sname" value="formbean.sname" listValue="sname" cssStyle="height:20px;border:1px solid #ccc;background:#FFFF99;width:100px;" onchange="citycode();" tabindex="3"/></td>
       </tr>
    ...
    <br/>
      ...
      <div align="right" style="width:99%;position:relative;padding:7px;">
      	...
      	<s:submit name="formbean.save" value="Save District" cssClass="butStnd" onclick="return Validate()" ></s:submit>
	...
	<display:column property="name"   title="Place Name" style="background-color:#ecf2f6;"   sortable="false" headerClass="sortable" />
	
	<display:column property="pcode"   title="Postal_Code" style="background-color:#ecf2f6;"   sortable="false" headerClass="sortable" />
	
	<display:column property="sname"   title="City Name" style="background-color:#ecf2f6;"   sortable="false" headerClass="sortable" />
	
	<display:column title="Update" media="html" style="text-align: center;width:8%;background-color:#ecf2f6;" >
    <a href="<s:url action="placeupdate" namespace="/" ><s:param  name="id" value="%{#attr.table.id}"></s:param></s:url>" style="color:  #fff;text-decoration:none;font-size:12px;" class="classname">Update</a>
    </display:column>
    
    <display:column title="Delete" media="html" style="text-align: center;width:8%;background-color:#ecf2f6;" >
    <a href="<s:url action="placedelete" namespace="/" ><s:param  name="id" value="%{#attr.table.id}"></s:param></s:url>" style="color:  #fff;text-decoration:none;font-size:12px;" class="print" onclick="return confirmation();">Delete</a>
    </display:column>
	</s:if>
	<s:else>
		 
	<display:column property="name"   title="Place Name"  style="background-color:#fff;"  sortable="false" headerClass="sortable" />
	<display:column property="pcode"   title="Postal Code"  style="background-color:#fff;"  sortable="false" headerClass="sortable" />
	<display:column property="sname"   title="City Name"  style="background-color:#fff;"  sortable="false" headerClass="sortable" />
    ...
    <a href="<s:url action="placedelete" namespace="/" ><s:param  name="id" value="%{#attr.table.id}"></s:param></s:url>" style="color: #fff;text-decoration:none;font-size:12px;" class="print" onclick="placerecordcheck('<s:property value="%{#attr.table.scode}"/>');return confirmation();">Delete</a>
    </display:column>
