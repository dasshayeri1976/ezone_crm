 	...
 	try
 		{
			...
			Statement stm = ConnectionDAO.createStatement(conn); 
 			...
 			ResultSet rs = stm.executeQuery("Select * from city_master where DISTRICT_CODE like '%"+districtcode+"%'");
 			System.out.println("Select * from city_master where DISTRICT_CODE like '%"+districtcode+"%'");
			while(rs.next())
				{
					//s1= rs.getString(2);
