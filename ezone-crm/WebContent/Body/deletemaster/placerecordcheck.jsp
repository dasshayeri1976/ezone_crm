 	...
 	try
 		{
			...
			Statement stm = ConnectionDAO.createStatement(conn); 
 			...
 			ResultSet rs = stm.executeQuery("Select * from place_master where place_code like '%"+placecode+"%'");
			...
			rs = stm.executeQuery("Select * from jobwork_entry where place_code like '%"+s1+"%'");
