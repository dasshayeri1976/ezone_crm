 	...
 	try
 		{
			...
			Statement stm = ConnectionDAO.createStatement(conn); 
 			...
 			ResultSet rs = stm.executeQuery("Select * from engineer_master where engineer_code like '%"+engcode+"%'");
			...
			rs = stm.executeQuery("Select * from jobwork_entry where allocated_engr like '%"+s1+"%'");
 			System.out.println("Select * from jobwork_entry where allocated_engr like '%"+s1+"%'");
			while(rs.next())
				{
					//s1= rs.getString(3);
					//System.out.println(s1);
