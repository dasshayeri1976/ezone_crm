 	...
 	try
 		{
			...
			Statement stm = ConnectionDAO.createStatement(conn); 
 			...
 			ResultSet rs = stm.executeQuery("Select * from brand_master where brand_code like '%"+trancode+"%'");
			...
			rs = stm.executeQuery("Select * from jobwork_entry where brand like '%"+s1+"%'");
 			//System.out.println("Select * from jobwork_entry where brand like '%"+trancode+"%'");
			while(rs.next())
				{
					//s1= rs.getString(3);
