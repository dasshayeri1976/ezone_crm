 	...
 	try
 		{
			...
			Statement stm = ConnectionDAO.createStatement(conn); 
 			...
 			ResultSet rs = stm.executeQuery("Select * from spare_master where spare_code like '%"+sparecode+"%'");
			...
			rs = stm.executeQuery("Select * from spare_table where spare_name like '%"+s1+"%'");
