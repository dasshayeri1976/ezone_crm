 	...
 	try
 		{
			...
			Statement stm = ConnectionDAO.createStatement(conn); 
 			...
 			ResultSet rs = stm.executeQuery("Select * from model_master where model_code like '%"+modelcode+"%'");
			...
			rs = stm.executeQuery("Select * from jobwork_entry where model_code like '%"+s1+"%'");
