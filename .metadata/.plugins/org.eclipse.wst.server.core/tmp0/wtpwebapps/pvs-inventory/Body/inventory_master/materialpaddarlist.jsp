...
<s:actionmessage/>
  ...
  <table cellpadding="5" width="50%" style="padding:5px">  
  		...
  		<tr>	
        	...
        	<td width="12.5%" style="padding-left:15px; padding-right:15px;"><s:textfield name="formbean.materialname"  id="materialname" cssClass="materialname" size="20" cssStyle="height:25px;border:1px solid #ccc;background:#FFFF99"></s:textfield></td>
     <td></td>
     </tr>
    ...
    <td></td>
       	...
       	<tr>
        	...
        	<td width="12.5%" style="padding-left:15px; padding-right:15px;">
        	 <sj:autocompleter name="materialgroup" id="materialgroup" cssClass="materialgroup" list="usList2"  listValue="materialgroup" size="20" cssStyle="height:25px;border:1px solid #ccc;background:#FFFF99" forceValidOption="false" onfocusout="groupcode();"></sj:autocompleter>
        ...
        <td width="12.5%" style="padding-left:15px; padding-right:15px;"><label>M.&nbsp;Type</label></td>
        	...
        	<td width="12.5%" style="padding-left:15px; padding-right:15px;">
        	 <sj:autocompleter name="purchase1" id="purchase1" cssClass="purchase1" list="usList5"  listValue="pur" size="20" cssStyle="height:25px;border:1px solid #ccc;background:#FFFF99" forceValidOption="false"></sj:autocompleter> 
       ...
       <td width="12.5%" style="padding-left:15px; padding-right:15px;"><label>Size</label></td>
        	...
        	<td width="12.5%" style="padding-left:15px; padding-right:15px;">
        	 <sj:autocompleter name="salesac1" id="saleac" cssClass="salesac" list="usList6"  listValue="sl" size="20" cssStyle="height:25px;border:1px solid #ccc;background:#FFFF99" forceValidOption="false"></sj:autocompleter> 
            ...
            <td width="12.5%" style="padding-left:15px; padding-right:15px;"></td>
        	<td width="12.5%" style="padding-left:15px; padding-right:15px;"></td>
       <td width="12.5%" style="padding-left:15px; padding-right:15px;"><label>S.&nbsp;Unit</label></td>
         ...
         <tr>
        	...
        	<td width="12.5%" style="padding-left:15px; padding-right:15px;">
        	<sj:autocompleter name="formbean.companyname" id="companyname" list="usList4"  listValue="companyname" size="20" cssStyle="height:25px;border:1px solid #ccc;background:#FFFF99" forceValidOption="false" onfocusout="companycode();"></sj:autocompleter>
        ...
        <td width="12.5%" style="padding-left:15px; padding-right:15px;"><label>Min&nbsp;inv&nbsp;level</label></td>
         ...
         <td width="12.5%" style="padding-left:15px; padding-right:15px;"></td>
        	<td width="12.5%" style="padding-left:15px; padding-right:15px;"></td>
        <td width="12.5%" style="padding-left:15px; padding-right:15px;"><label>Type&nbsp;of&nbsp;Tax</label></td>
   ...
   <fieldset style="width:30%; border:solid thin #c6d5e1;Padding:5px;">
    ...
    <tr>
        ...
        <td width="9%" style="font-size:14px"><s:textfield name="formbean.rtcase" id="rtcase" cssClass="rtcase" size="10" cssStyle="height:20px;border:1px solid #ccc;background:#FFFF99" onkeyup="PersonViewModel(this);multi1();tototal();"></s:textfield></td>
  ...
  <s:else>
     <s:iterator value="formbean.pcase" status="status">
        ...
        <td width="9%" style="font-size:14px"><s:textfield name="formbean.rtcase[%{#status.count-1}]" id="rtcase" cssClass="rtcase" size="10" cssStyle="height:20px;border:1px solid #ccc;background:#FFFF99" onkeyup="PersonViewModel(this);multi1();tototal();"></s:textfield><input type="hidden" name="formbean.rtcase1" id="rtcase1" class="rtcase1"></input></td>
  ...
  <td width="12.5%" style="padding-left:15px; padding-right:15px;"><label>Total&nbsp;Amount</label></td>
   ...
   <div align="right" style="width:99%;position:relative;  padding:7px;">
	...
	<display:column property="mfgcode"   title="mfgcode" style="background-color:#ecf2f6;"   sortable="false" headerClass="sortable" />
	...
	<display:column property="materialname"   title="material name" style="background-color:#fff;"   sortable="false" headerClass="sortable" />
	
	<display:column property="sname"   title="Short Name"  style="background-color:#fff;"   sortable="false" headerClass="sortable"/>
	
	<display:column property="mfgcode"   title="mfg code" style="background-color:#fff;"   sortable="false" headerClass="sortable" />
