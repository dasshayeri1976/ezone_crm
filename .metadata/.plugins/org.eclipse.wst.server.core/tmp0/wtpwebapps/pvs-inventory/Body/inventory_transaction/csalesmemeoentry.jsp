...
//alert(lc);
 ...
 function showdiv1()
 {
   ...
   //  var repl=document.getElementsByClassName("replacement");
     ...
     var url = "./Body/inventory_transaction/meteriallistvalue.jsp";
     url += "?count=" + matname[lc-1].value+"bubun"+s1;
     //alert(url);
...
<s:actionmessage/>
  ...
  <legend style="color:red;">ENTRY OF CASH/CREDIT MEMO FOR SALES(COUNTER)</legend>
  
  <s:form action="csalesmemeocreation" namespace="/" method="post" autocomplete="off">
  ...
  <table cellpadding="5" width="50%" style="padding:5px">  
   ...
   <fieldset style="width:30%; border:solid thin #c6d5e1;Padding:5px;">
    ...
    <tr>
       ...
       <%--  <s:textfield name="formbean.nameofitems" id="nameofitems"  cssClass="nameofitems" size="50" cssStyle="height:20px;border:1px solid #ccc;background:#FFFF99;" ></s:textfield>
        ...
        <td width="9%" style="font-size:14px"><s:textfield name="formbean.discs" id="discs" cssClass="discs" size="10" cssStyle="height:20px;border:1px solid #ccc;background:#FFFF99" onkeyup="PersonViewModel(this);discou();pdiscou();gstp();" onfocusout="PersonViewModel(this);tototal();distotal();"></s:textfield></td>
   	   ...
   	   <td width="9%" style="font-size:14px">
   	   <s:textfield name="formbean.dis" id="dis" cssClass="dis"  size="10" cssStyle="height:20px;border:1px solid #ccc;background:#FFFF99" onkeyup="pdiscou();" onfocusout="PersonViewModel(this);tototal();distotal();gstp();"></s:textfield>
   	   
   	   </td>
        	 
        
        <td width="9%" style="font-size:14px">
        <s:textfield name="formbean.amount4" id="amount4" cssClass="amount4" size="10" cssStyle="height:20px;border:1px solid #ccc;background:#FFFF99" onfocusout="addRow('table111');"></s:textfield>
    ...
    <%-- 
        ...
        <td width="9%" style="font-size:14px"><s:textfield name="formbean.rate[%{#status.count-1}]" id="rate" cssClass="rate" size="10" cssStyle="height:20px;border:1px solid #ccc;background:#FFFF99" onfocusout="PersonViewModel(this);"></s:textfield><input type="hidden" name="formbean.rate4" id="rate4" class="rate4"></input></td>
          <td width="9%" style="font-size:14px"><s:textfield name="formbean.discs[%{#status.count-1}]" id="discs" cssClass="discs" size="10" cssStyle="height:20px;border:1px solid #ccc;background:#FFFF99" onfocusout="PersonViewModel(this);"></s:textfield><input type="hidden" name="formbean.discs4" id="discs4" class="discs4"></td>
        ...
        <td width="9%" style="font-size:14px"><s:textfield name="formbean.amount4[%{#status.count-1}]" id="amount4" cssClass="amount4" size="10" cssStyle="height:20px;border:1px solid #ccc;background:#FFFF99" onfocusout="PersonViewModel(this);"></s:textfield><input type="hidden" name="formbean.amount5" id="amount5" class="amount5"></td>
...
<td width="12.5%" style="padding-left:150px;" ><label>Add</label></td>
   ...
   <div align="right" style="width:99%;position:relative;  padding:7px;">
    ...
    <a href="<s:url action="csalesmemeoupdate" namespace="/" ><s:param  name="id" value="%{#attr.table111.id}"></s:param></s:url>" style="color:  #fff;text-decoration:none;font-size:12px;" class="classname">Update</a>
    </display:column>
    
    <display:column title="Delete" media="html" style="text-align: center;width:8%;background-color:#ecf2f6;" >
    <a href="<s:url action="csalesmemeodelete" namespace="/" ><s:param  name="id" value="%{#attr.table111.id}"></s:param></s:url>" style="color:  #fff;text-decoration:none;font-size:12px;" class="print" onclick="return confirmation();">Delete</a>
    </display:column>
	</s:if>
	<s:else>
