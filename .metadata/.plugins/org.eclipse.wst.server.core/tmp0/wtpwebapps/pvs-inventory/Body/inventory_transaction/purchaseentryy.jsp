...
var su=0;
	 ...
	 document.getElementById("grossamt").value=su;
...
function famt()
{
	...
	document.getElementById("billamt").value = min;
	...
	if(id==nul)
		{
				...
				var b=document.getElementById("dated").value;
				...
				var fina= fin+fin2+""+a;
				document.getElementById("vouno").value=fina;
...
<s:actionmessage/>
  ...
  <input type="hidden" name="formbean.vou" id="vou" value="<s:property value="formbean.vou"/>"/>
  ...
  <table cellpadding="5" width="50%" style="padding:5px">  
          ...
          <td width="12.5%" style="padding-left:15px; padding-right:15px;"></td>
			...
			<td width="12.5%" style="padding-left:15px; padding-right:15px;"><sj:autocompleter name="formbean.creditors" id="creditors" list="usList2"  listValue="creditors" size="30" cssStyle="height:25px;border:1px solid #ccc;background:#FFFF99" forceValidOption="false" onblur="suncre();" onfocus="getname1();sttype1()"></sj:autocompleter></td>
       ...
       <td width="12.5%" style="padding-left:15px; padding-right:15px;"><label>Date</label></td>
            ...
            <td width="12.5%" style="padding-left:15px; padding-right:15px;"></td>
        	<td width="10.5%" style="padding-left:15px; padding-right:15px;"></td>
       <td width="12.5%" style="padding-left:15px; padding-right:15px;"><label>Dated&nbsp;</label></td>
        	<td width="13.5%" style="padding-left:15px; padding-right:15px;" valign="top"><sj:datepicker name="formbean.dated" id="dated" cssClass="dated" size="20" buttonImageOnly="true" displayFormat="yy-mm-dd" showButton="false"  changeYear="true" changeMonth="true"  cssStyle="height:20px;border:1px solid #ccc;background:#FFFF99" onfocus="vouchercreate();"  onclick="view();"/></td></tr>
   ...
   <fieldset style="width:30%; border:solid thin #c6d5e1;Padding:5px;">
	...
	<!-- <tr  style="background-color:#4292b2;color:white;" align="center">        
	 ...
	 <tr  style="background-color:#4292b2;color:white;" align="center">        
        ...
        <th width="9%" style="font-size:11.2px">Gstp</th>
    ...
    <tr>
        ...
        <td width="9%" style="font-size:14px"><s:textfield name="formbean.gstp" id="gstp" cssClass="gstp" size="10" cssStyle="height:20px;border:1px solid #ccc;background:#FFFF99" ></s:textfield></td>
    ...
    <s:else>
     <s:iterator value="formbean.nameofitems" status="status">
        ...
        <td width="9%" style="font-size:14px"><s:textfield name="formbean.tax1[%{#status.count-1}]" id="tax" cssClass="tax" size="12" cssStyle="height:20px;border:1px solid #ccc;background:#FFFF99" ></s:textfield><input type="hidden" name="formbean.tax11" id="tax11" class="tax11"></input></td> 
       	  <td width="9%" style="font-size:14px"><s:textfield name="formbean.gstp[%{#status.count-1}]" id="gstp" cssClass="gstp" size="12" cssStyle="height:20px;border:1px solid #ccc;background:#FFFF99" ></s:textfield><input type="hidden" name="formbean.gstp1" id="gstp1" class="gstp1"></input></td>	 	        
       </tr>
     </s:iterator>
    </s:else>   
