					...
					<li><a>Inventory Transaction</a>
						<ul>
							<li><a>Purchase Entry</a>
								<ul>
									<li><a href="crpurchaselist">Credit Purchase Entry</a></li>
									<li><a href="chpurchaselist">Cash Purchase Entry</a></li>
									<li><a href="purchaseretlist">Purchase Return Entry</a></li>
								</ul>
							</li>	
							<li><a>Sales Memo Entry</a>
								<ul>
									<li><a href="outsidesaleslist">Outside Sales Memo Entry</a></li>
									<li><a href="countersaleslist">Counter Sales Memo Entry</a></li>
									<li><a href="mrpsaleslist">M.R.P Wise Sales Entry</a></li>
									<li><a href="distsaleslist">Distributor Wise Sales Entry</a></li>
								</ul>
							</li>
							...
							<li><a href="">Others Entry Modules</a></li>
								<ul>
									...
									<li><a href="salesreturnlist">Sales Return Entry</a></li>
